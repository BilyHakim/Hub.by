...
export const api = {
  ...
  watchCatalogTitle: (imdbId) => request(`/watch/catalog/titles/${encodeURIComponent(imdbId)}`),
  watchCatalogSeason: (imdbId, season) => request(`/watch/catalog/titles/${encodeURIComponent(imdbId)}/seasons/${season}`),
  me: () => request('/me'),
